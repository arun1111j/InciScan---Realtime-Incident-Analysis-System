        ...
        <div className="flex min-h-screen items-center justify-center bg-gray-900 font-sans">
            <div className="w-full max-w-md p-8 bg-gray-800 rounded-2xl shadow-2xl border border-gray-700">
                <div className="flex flex-col items-center mb-8">
                    ...
                    <h2 className="text-3xl font-bold text-white tracking-wide">InciScan</h2>
                    <p className="text-gray-400 text-sm">Secure Operation Center Access</p>
                </div>
                ...
                <div className="mt-6">
                    <button
                        ...
                        className="w-full flex items-center justify-center space-x-3 py-3 bg-white hover:bg-gray-100 text-gray-900 font-medium rounded-lg transition-colors"
                    >
